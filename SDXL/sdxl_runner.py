...
from sdxl_embed_fuser import SDXLEmbedFuser
from sdxl_integration import normalize_simplex
from sdxl_config import get_stage_strength
...
class SDXLRunner:
    ...
    def generate_from_mixture(
        ...
        Args:
            w: Weight vector (K,) - relative importances of concepts (will be normalized)
            ...
            num_negatives: Not used (kept for compatibility)
        ...
        # Step 1: Normalize weights (relative importances) - do this ONCE
        ...
        # Build concept tag phrases with their weights
        tag_phrases = []
        tag_weights = []
        ...
        # Step 2: Fuse embeddings with alpha scaling: e_total = e_desc + alpha * e_tags
        ...
        if verbose:
            print(f"\n[SDXLRunner] Fusing embeddings: e_total = {1-alpha:.2f}*e_desc + {alpha:.2f}*e_tags...")
        ...
        if tracker is not None and proposal_index is not None:
            ...
            # Build tracking info: phrases with their weights
            pos_phrases_tracking = [(p, w) for p, w in zip(tag_phrases, tag_weights_array)]
            ...
            tracker.add_proposal(
                ...
                concepts=concepts,
                descriptor=descriptor,
                pos_phrases=pos_phrases_tracking,
                neg_phrases=neg_phrases,
